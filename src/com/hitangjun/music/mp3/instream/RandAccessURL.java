 ...
 * 简单有效解决死锁?
 */
public final class RandAccessURL implements IRandomAccess, IWriterCallBack {
	...
	public RandAccessURL(String sURL) throws Exception {
		this(sURL,MAX_WRITER);
	}

	public RandAccessURL(String sURL, int download_threads) throws Exception {
